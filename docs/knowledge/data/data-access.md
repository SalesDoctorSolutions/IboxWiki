...
:::info Информация
Назначить роли можно в разделе **Настройки → Сотрудники** ([Гайд по быстрому старту, часть 1](/docs/quick-start/part1-registration), и раздел [Настройки ролей в iBOX](/docs/knowledge/access/access-role))
:::
