...
<img src="/img/knowledge/products/product-add-1.png" alt="Добавление товара в iBox" width="600" />
...
<img src="/img/knowledge/products/product-add-2.png" alt="Добавление товара в iBox" width="600" />
6. Откройте вкладку **Минимальный остаток** и укажите его по каждому складу или по общему остатку.
<img src="/img/knowledge/products/product-add-3.png" alt="Добавление товара в iBox" width="600" />
...
<img src="/img/knowledge/products/product-add-4.png" alt="Добавление товара в iBox" width="600" />
...
<img src="/img/knowledge/products/product-add-org-1.png" alt="Добавление товара в iBox" width="600" />
3. В окне **Добавить (прикрепить) товары и услуги** выберите нужные товары.
<img src="/img/knowledge/products/product-add-org-2.png" alt="Добавление товара в iBox" width="600" />
4. Нажмите **Применить**.
...
- Название товара
- Единица хранения
<img src="/img/knowledge/products/products-excel.png" alt="Товары в Excel" width="600" />
### Дополнительные поля
...
Если их нет, сначала добавьте их в разделе **Настройки → Общие настройки**.
:::
...
3. Выберите **Импорт**.
<img src="/img/knowledge/products/product-import-1.png" alt="Добавление товара в iBox" width="600" />
4. Перетащите файл в окно импорта или выберите его на компьютере.
5. Сопоставьте столбцы из файла с полями системы.
<img src="/img/knowledge/products/product-import-2.png" alt="Добавление товара в iBox" width="600" />
