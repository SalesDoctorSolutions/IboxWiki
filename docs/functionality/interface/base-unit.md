---
id: base-unit
title: Документы только в базовой единице
sidebar_label: Документы только в базовой единице
sidebar_position: 1
---

Функция **Документы только в базовой единице** позволяет автоматически пересчитывать количество товаров из разных упаковок в единицу хранения.
