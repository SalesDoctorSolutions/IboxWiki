...
- [Скорректируйте остатки вручную](/docs/knowledge/warehouse/stock-adjustment), если нашли ошибку 
- [Верните товар поставщику](/docs/knowledge/purchase/supplier-return), если он не продается или оказался лишним 
- [Переместите товар между складами](/docs/knowledge/warehouse/new-transfer), чтобы сбалансировать остатки 
