...
Чтобы вносить оплату через **Отгрузки** при создании или редактировании карточки, включите *Возможность распределять оплату по отгрузкам* в **Функционале**. Подробнее читайте [в статье](/docs/knowledge/settings/functional).
:::
