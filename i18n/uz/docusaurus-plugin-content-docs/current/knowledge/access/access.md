...
:::warning **Важно**  
Даже если сотрудник будет работать только через мобильное приложение, роль все равно нужно назначить — хотя бы пустую.  
Без роли сотрудник не сможет войти в систему и авторизоваться в приложении.
:::
