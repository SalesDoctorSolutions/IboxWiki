...
**Анализ остатков** — показывает, что продается хорошо, а что залежалось. Можно увидеть общую и среднюю себестоимость товаров.
...
**Заказы поставщикам** — список всех заказов поставщикам. 
...
- **Отгрузки** — сумма заказов, которые уже отправлены
