...
8. Нажмите **Сохранить** — ваш заказ появится в списке с выбранными вами  статусом (например, *Принят*)
...
5. Нажмите **Сохранить** — заказ появится в общем списке с выбранным вами статусом (например, *Принят*)
...
7. Нажмите **Сохранить**, и заказ появится в списке с выбранным вами статусом (например, *К отгрузке*)
