...
В модуле **Товары** можно загрузить прайс-лист в Excel или добавить товары вручную. Не забудьте указать минимальный остаток на складе, чтобы вовремя пополнять запасы и не допускать дефицита. Смотрите также [Инструкции по работе с товарами](/docs/knowledge/goods/goods-add.md).
